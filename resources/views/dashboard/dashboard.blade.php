...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <title>Admin E-Voting SMKN I JENANGAN | @yield('judul_halaman')</title>
...
<body>
  ...
  <div id="wrapper">
    ...
    <footer>
      <div class="container-fluid">
        <p class="copyright">&copy; 2020 <a href="https://www.themeineed.com" target="_blank">Made With ♥</a>. By @xxgbrlswgsr.</p>
      </div>
    </footer>
  </div>
  <!-- END WRAPPER -->
